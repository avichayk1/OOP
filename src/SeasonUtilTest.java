...
public class SeasonUtilTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(SeasonUtil.reportAll(trees));
        /*Comparable[] c=new Comparable[trees.length+animals.length] ;
        System.arraycopy(trees, 0, c, 0, trees.length);
        System.arraycopy(animals, 0, c, trees.length,animals.length);
        SeasonUtil.sortSeasonable(c);*/
